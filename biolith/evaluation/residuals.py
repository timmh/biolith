...
def residuals(
    ...
    ----------
        ...
        obs: Ground truth observations of shape
            (n_species, n_sites, n_periods, n_replicates).

    Returns
    -------
        A tuple containing:
        - jnp.ndarray: Occupancy residuals of shape
            (n_samples, n_periods, n_sites, n_species).
        - jnp.ndarray: Detection residuals of shape
            (n_samples, n_species, n_sites, n_periods, n_replicates).
    ...
    obs_transposed = obs.transpose((3, 2, 1, 0))
    ...
    detection_residuals = detection_residuals_transposed.transpose((0, 4, 3, 2, 1))
